 ...
 */
public class ActionExceptionCondition extends Condition {

	private String condition;
	private boolean conditionResult;

	public ActionExceptionCondition(String actionTypeName, String exceptionTypeName) {
		/*
			...
			"<ActionTypeName>".equals(mapping.getType())
		*/
		...
		.append(actionTypeName).append("\".equals(mapping.getType())");
