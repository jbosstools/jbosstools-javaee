...
public class StrutsRenameFolderParticipant extends RenameParticipant {
	public static final String PARTICIPANT_NAME="struts-RenameFolderParticipant";
	XModelObject object;
	...
	public Change createChange(IProgressMonitor pm) throws CoreException, OperationCanceledException {
		if (!pm.isCanceled()) {
			...
			StrutsRenameFolderStrutsConfigChange change = new StrutsRenameFolderStrutsConfigChange(object, newName);
