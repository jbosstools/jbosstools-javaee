...
public class SelectExceptionPathStep extends TabbedStep {

	protected AbstractSpecialWizardStep[] createTabs() {
		return new AbstractSpecialWizardStep[]{new SelectActionScreen(), new SelectPageStep()};
	}

	protected String getTabName(int i) {
		return (i == 0) ? "Actions" : "Pages";
	}
