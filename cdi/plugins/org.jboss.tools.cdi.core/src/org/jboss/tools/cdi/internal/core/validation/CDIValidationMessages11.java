 ...
 */
public class CDIValidationMessages11 {

	private static final String BUNDLE_NAME = "org.jboss.tools.cdi.internal.core.validation.messages11"; //$NON-NLS-1$
...
//	public static String MISSING_BEANS_XML;
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, CDIValidationMessages11.class);
	}
}