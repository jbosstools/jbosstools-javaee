...
public class NewCDIWebProjectWizardTest extends TestCase{
	...
	public void testCDI11ProjectCreated() throws Exception {
		assertCDIProjectCreated(IJ2EEFacetConstants.DYNAMIC_WEB_30, "beans11.xml", CDIProjectWizard.CDI11_TEMPALTE);
	}

	public void testCDI12ProjectCreated() throws Exception {
		assertCDIProjectCreated(IJ2EEFacetConstants.DYNAMIC_WEB_31, "beans12.xml", CDIProjectWizard.CDI12_TEMPALTE);
	}

	public void testCDI20ProjectCreated() throws Exception {
		assertCDIProjectCreated(IJ2EEFacetConstants.DYNAMIC_WEB_31, "beans20.xml", CDIProjectWizard.CDI20_TEMPALTE);
	}
