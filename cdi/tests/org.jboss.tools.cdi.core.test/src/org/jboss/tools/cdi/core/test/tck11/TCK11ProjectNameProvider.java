 ...
 */
public class TCK11ProjectNameProvider implements ITCKProjectNameProvider {

	private final static String MAIN_PROJECT_NAME = "tck1.1";
	private final static String[] PROJECT_NAMES = {"tck1.1-parent", MAIN_PROJECT_NAME, "tck1.1-child"};
	private final static String MAIN_PROJECT_PATH = "/projects/tck1.1";
	private final static String[] PROJECT_PATHS = {"/projects/tck1.1-parent", MAIN_PROJECT_PATH, "/projects/tck1.1-child"};
