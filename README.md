...
_=JavaEE Tools_ is part of [JBoss Tools](http://jboss.org/tools) from
...
To build _=JavaEE Tools_ requires specific versions of Java and
...
_=JavaEE Tools_ is open source, and we welcome anybody that wants to
