...
/**
 * Test of
 * <a href="https://jira.jboss.org/jira/browse/JBIDE-4037">JBIDE-4037</a>:
 * Visual part of VPE doesn't display/select automatically currently selected
...
public class JBIDE4037Test extends VpeTest {
	...
	public JBIDE4037Test() {
	}

	/**
	 * Checks if the first element in the test file is selected in the VPE when
	 * the VPE is just loaded.
	 * 
	 * @throws Throwable
	 */
	@Test
	public void testJBIDE4037Test() throws Throwable {
		...
		nsIDOMElement rootElement = TestUtil.getVpeController(part).getXulRunnerEditor().getSelectedElement();

		// check if something selected
		assertNotNull(rootElement);
		// check if the selected element is the first element on the page (we
		// know its ID)
